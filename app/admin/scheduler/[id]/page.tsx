...
export default function SchedulerPeriodPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  ...
  if (!period) {
    return (
      <div className="text-center py-24">
        ...
        <Button variant="outline" className="mt-6" onClick={() => router.push("/admin/scheduler")}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button 
                ...
                onClick={() => handleDeleteEvent(id)} // This should probably be deletePeriod
              >
